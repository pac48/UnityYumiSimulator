...
set "PYTHONPATH=C:\Program Files (x86)\Project\lib/site-packages;C:/Users/paulg/UnityProjects/project/Assets/ROS/src/cmake-build-release\lib/site-packages"
set "CATKIN_BINARY_DIR=C:/Users/paulg/UnityProjects/project/Assets/ROS/src/cmake-build-release"
...
"C:/opt/ros/noetic/x64/python.exe" ^
    ...
    build --build-base "C:/Users/paulg/UnityProjects/project/Assets/ROS/src/cmake-build-release/xacro" ^
    install %DESTDIR_ARG%  ^
