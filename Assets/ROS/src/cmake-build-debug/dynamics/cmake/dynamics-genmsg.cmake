...
message(STATUS "dynamics: 0 messages, 2 services")

set(MSG_I_FLAGS "-Istd_msgs:C:/opt/ros/noetic/x64/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "C:/Users/paulg/UnityProjects/project/Assets/ROS/src/dynamics/srv/getStaticTorques.srv" NAME_WE)
add_custom_target(_dynamics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamics" "C:/Users/paulg/UnityProjects/project/Assets/ROS/src/dynamics/srv/getStaticTorques.srv" ""
)

get_filename_component(_filename "C:/Users/paulg/UnityProjects/project/Assets/ROS/src/dynamics/srv/setTorques.srv" NAME_WE)
add_custom_target(_dynamics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamics" "C:/Users/paulg/UnityProjects/project/Assets/ROS/src/dynamics/srv/setTorques.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamics)
  install(CODE "execute_process(COMMAND \"C:/opt/ros/noetic/x64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamics\")")
  # install generated code
  install(
